...
<div class="analysis-item">
  ...
  <div class="analysis-tier analysis-tier-implication">
    <div class="analysis-label analysis-label-implication">함의</div>
    <p>...</p>
  </div>
</div>
```
...
- `analysis-tier-implication`: 좌측 보더 라임 + 반투명 배경 — 한국 사업자 액션

### 목표

- **1회 독자**: 함의만 읽어도 "이게 나한테 왜 중요한지" 파악 가능
- **4회(1개월) 독자**: 신호·맥락 3개 × 4주 = 12개를 모으면 지역별 트렌드 맵 완성
- **12회(3개월) 독자**: 함의의 누적이 사업 전략 방향의 근거 자료가 됨
